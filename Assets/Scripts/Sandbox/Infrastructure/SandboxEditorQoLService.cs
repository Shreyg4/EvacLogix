    ...
    public sealed class SandboxEditorQoLService : MonoBehaviour
    {
        ...
        private void HandleToolModeChanged(SandboxToolMode toolMode)
        {
            currentToolHelpText = toolMode switch
            {
                ...
                SandboxToolMode.WallLine => "Place two points to trace precise wall centerlines with snapping.",
                SandboxToolMode.WallBrush => "Sketch rough wall paths, then clean them before accepting.",
