...
export const homeContent: HeroContent = {
  ...
  body:
    "EvacLogix is a presentation-focused simulation project that frames evacuation safety as a human problem first, then demonstrates how interactive simulation can help people understand movement, congestion, and response behavior inside buildings.",
...
export const homeProblemStatement: StatementContent = {
  ...
  body:
    "People rarely get to see how congestion, limited exits, and evolving hazards affect evacuation behavior until a crisis is already underway. That makes safety planning harder to communicate, evaluate, and improve."
};
...
export const homeSolutionStatement: StatementContent = {
  ...
  body:
    "By presenting evacuation scenarios as an interactive simulation, the project gives viewers a clearer way to examine building response, movement patterns, and the tradeoffs that appear when many people must leave at once."
};
...
export const homeImpactStatement: StatementContent = {
  ...
  body:
    "The project is grounded in a campus and community safety framing: helping viewers think more concretely about evacuation routes, building layouts, and the design decisions that shape safe exits."
};
...
export const homeDemoPreview = {
  ...
  body:
    "The website introduces the mission, but the demo route is where viewers engage the embedded simulation directly. In the finished experience, controls remain inside Unity while the site frames what the audience should look for.",
