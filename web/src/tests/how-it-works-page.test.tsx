...
describe("how it works page", () => {
  it("renders the route hero and section heading", async () => {
    ...
    expect(
      screen.getByRole("heading", { name: howItWorksPanelsSection.title })
    ).toBeInTheDocument();
  });
  ...
  it("keeps the page high level and user-facing", async () => {
    ...
    expect(screen.getByText(/without turning into a low-level systems specification/i)).toBeInTheDocument();
  });
});
