...
## Unity AI Agent Decisions (Incremental)

This section records Unity sandbox AI decisions one feature at a time, with the chosen option logged after a decision is made.

### Feature 1: Fire-aware traversal cost model
...
### Feature 2: Fire spread integration
...
### Feature 4: Behavior tuning for crowd realism
...
### Feature 5: Failure handling and fallback behavior
...
### Feature 6: Agent data model for AI controls
...
### Feature 10: Fire proximity metric for health decay
...
### Feature 11: Health display format
...
### Feature 12: Speed display format
...
### Feature 13: Agent selection method
...
### Feature 14: Hover selection behavior for UI clarity
...
### Feature 15: Replan cadence (timer interval)
...
### Feature 16: Replan trigger on hazard update
...
### Feature 17: Blocked-path handling (window break option)
...
### Feature 18: Window-break eligibility
...
### Feature 19: Window-break cost tradeoff
